      ...
      <div className="flex gap-2 mb-4">
        <button
          ...
          className={`px-3 py-1 rounded-full text-sm cursor-pointer ${
            selectedType === 'home' ? 'bg-blue-500 text-white' : 'bg-gray-200 text-gray-700 hover:bg-gray-300'
          }`}
        >
          🏠 Home
        </button>
        <button
          ...
          className={`px-3 py-1 rounded-full text-sm cursor-pointer ${
            selectedType === 'work' ? 'bg-blue-500 text-white' : 'bg-gray-200 text-gray-700 hover:bg-gray-300'
          }`}
        >
          💼 Work
        </button>
        <button
          ...
          className={`px-3 py-1 rounded-full text-sm cursor-pointer ${
            selectedType === 'plus' ? 'bg-blue-500 text-white' : 'bg-gray-200 text-gray-700 hover:bg-gray-300'
          }`}
        >
          ➕ Plus
        </button>
