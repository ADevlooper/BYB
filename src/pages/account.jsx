      ...
      const invoiceHTML = `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #ddd;">
          <div style="text-align: center; margin-bottom: 30px;">
            <h1 style="color: #dc2626; margin: 0;">BakeBite</h1>
          ...
          <div style="text-align: right; margin-top: 20px; padding-top: 20px; border-top: 2px solid #dc2626;">
            <h3 style="color: #dc2626; margin: 0;">Total: $${order.total.toFixed(2)}</h3>
          </div>

          <div style="margin-top: 30px; text-align: center; color: #666; font-size: 12px;">
            <p>Thank you for shopping with BakeBite!</p>
        ...
        return (
          <div className="bg-white p-6 rounded-lg shadow-md">
            <div className="flex flex-wrap justify-between items-baseline mb-6">
              <h1 className="text-3xl font-bold text-red-800">{getHeaderText()}</h1>
              <OrderFilters
                    ...
                    <div key={order.id} className="bg-red-50 rounded-lg shadow-md p-4 mb-3">
                      <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start gap-4">
                        ...
                        <div className="flex-1">
                          <div className="mb-2">
                            <span className="text-red-800 font-medium">Order ID:</span>
                            <span className="text-gray-900 ml-1">{order.id}</span>
                          </div>
                          <div className="mb-2">
                            <span className="text-red-800 font-medium">Order Placed On:</span>
                        ...
                        <div className="flex-shrink-0">
                          <button
                            ...
                            className="bg-red-800 text-white px-4 py-2 rounded hover:bg-red-900 text-sm font-medium transition-colors"
                          >
                            View Details
                          </button>
                        </div>
